...
const fixedSeedData = async () => {
  try {
    console.log('🌱 DICEL ERP - Fixed Seed Data Generation');
    console.log('==========================================');
    console.log('');
    ...
    console.log('🚀 Starting fixed seed data generation...');
    console.log('');
    ...
    console.log('🌱 Generating fixed seed data for empty tables...');
    console.log('');
          ...
          switch (table.name) {
            ...
            case 'Cash Flows':
              records.push({
                ...baseRecord,
                flow_date: new Date(),
                flow_type: ['operating', 'investing', 'financing'][Math.floor(Math.random() * 3)],
                category: ['sales', 'purchases', 'investments', 'loans', 'expenses', 'income'][Math.floor(Math.random() * 6)],
                amount: Math.floor(Math.random() * 5000000) + 100000,
                flow_direction: ['inflow', 'outflow'][Math.floor(Math.random() * 2)],
                status: ['pending', 'completed', 'cancelled', 'reversed'][Math.floor(Math.random() * 4)],
            ...
            case 'Systems':
              records.push({
                ...
                system_type: ['application', 'database', 'server', 'network', 'cloud', 'mobile', 'desktop', 'other'][Math.floor(Math.random() * 8)],
            ...
            case 'Maintenance Schedules':
              records.push({
                ...baseRecord,
                title: `Maintenance ${i}`,
                maintenance_type: ['preventive', 'corrective', 'emergency', 'upgrade', 'inspection', 'cleaning'][Math.floor(Math.random() * 6)],
                asset_type: ['it_asset', 'network_device', 'system', 'infrastructure', 'other'][Math.floor(Math.random() * 5)],
                scheduled_date: new Date(Date.now() + Math.floor(Math.random() * 30) * 24 * 60 * 60 * 1000),
                status: ['scheduled', 'in_progress', 'completed', 'cancelled', 'overdue'][Math.floor(Math.random() * 5)],
                created_by: users[Math.floor(Math.random() * users.length)].id,
            ...
            case 'Purchase Orders':
              records.push({
                ...
                subtotal: Math.floor(Math.random() * 4000000) + 100000,
                tax_amount: Math.floor(Math.random() * 400000) + 10000,
    ...
    console.log('');
    console.log('🎉 FIXED SEED DATA GENERATION COMPLETED!');
    console.log('');
    console.log('📊 SUMMARY:');
...
// Run the fixed seed data generation
fixedSeedData(); 