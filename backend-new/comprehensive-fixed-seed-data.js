...
const comprehensiveFixedSeedData = async () => {
  try {
    console.log('🌱 DICEL ERP - Comprehensive Fixed Seed Data Generation');
    console.log('========================================================');
    console.log('');
    ...
    console.log('🚀 Starting comprehensive fixed seed data generation...');
    console.log('');
    ...
    console.log('🌱 Generating comprehensive fixed seed data for empty tables...');
    console.log('');
          ...
          switch (table.name) {
            case 'Budgets':
              records.push({
                ...baseRecord,
                name: `Budget ${i}`,
                budget_type: ['department', 'project', 'operational', 'capital', 'revenue'][Math.floor(Math.random() * 5)],
                department_id: departments[Math.floor(Math.random() * departments.length)].id,
                fiscal_year: 2024,
                period: ['monthly', 'quarterly', 'annual'][Math.floor(Math.random() * 3)],
                start_date: new Date('2024-01-01'),
                end_date: new Date('2024-12-31'),
                total_budget: Math.floor(Math.random() * 50000000) + 1000000,
                allocated_amount: Math.floor(Math.random() * 30000000) + 500000,
                spent_amount: Math.floor(Math.random() * 20000000) + 100000,
                remaining_amount: Math.floor(Math.random() * 20000000) + 100000,
                status: ['draft', 'active', 'closed', 'cancelled'][Math.floor(Math.random() * 4)],
            ...
            case 'Accounts Receivable':
              const arAmount = Math.floor(Math.random() * 5000000) + 100000;
              const arTaxAmount = Math.floor(Math.random() * 500000) + 10000;
              const arTotalAmount = arAmount + arTaxAmount;
              const arPaidAmount = Math.floor(Math.random() * arTotalAmount);
              records.push({
                ...baseRecord,
                ...
                amount: arAmount,
                tax_amount: arTaxAmount,
                total_amount: arTotalAmount,
                paid_amount: arPaidAmount,
                outstanding_amount: arTotalAmount - arPaidAmount,
                status: ['pending', 'sent', 'paid', 'overdue', 'cancelled', 'disputed'][Math.floor(Math.random() * 6)],
            ...
            case 'Accounts Payable':
              const apAmount = Math.floor(Math.random() * 3000000) + 50000;
              const apTaxAmount = Math.floor(Math.random() * 300000) + 5000;
              const apTotalAmount = apAmount + apTaxAmount;
              const apPaidAmount = Math.floor(Math.random() * apTotalAmount);
              records.push({
                ...baseRecord,
                supplier_id: suppliers[Math.floor(Math.random() * suppliers.length)].id,
                bill_number: `BILL-${String(i).padStart(4, '0')}`,
                bill_date: new Date(),
                due_date: new Date(Date.now() + Math.floor(Math.random() * 30) * 24 * 60 * 60 * 1000),
                amount: apAmount,
                tax_amount: apTaxAmount,
                total_amount: apTotalAmount,
                paid_amount: apPaidAmount,
                outstanding_amount: apTotalAmount - apPaidAmount,
                status: ['pending', 'approved', 'paid', 'overdue', 'cancelled', 'disputed'][Math.floor(Math.random() * 6)],
                payment_terms: ['net_30', 'net_60', 'immediate', 'net_15'][Math.floor(Math.random() * 4)],
                created_by: users[Math.floor(Math.random() * users.length)].id,
            ...
            case 'Invoices':
              const invSubtotal = Math.floor(Math.random() * 1000000) + 50000;
              const invTaxAmount = Math.floor(Math.random() * 100000) + 5000;
              const invTotalAmount = invSubtotal + invTaxAmount;
              const invPaidAmount = Math.floor(Math.random() * invTotalAmount);
              records.push({
                ...baseRecord,
                invoice_number: `INV-${String(i).padStart(4, '0')}`,
                client_id: clients[Math.floor(Math.random() * clients.length)].id,
                ...
                outstanding_amount: invTotalAmount - invPaidAmount,
                invoice_type: ['service', 'product', 'subscription', 'one_time', 'recurring'][Math.floor(Math.random() * 5)],
                status: ['draft', 'sent', 'paid', 'overdue', 'cancelled', 'disputed', 'refunded'][Math.floor(Math.random() * 7)],
            ...
            case 'Tax Records':
              ...
              periodStart.setMonth(periodStart.getMonth() + (Math.floor(Math.random() * 12)));
            ...
            case 'Inventory Transactions':
              records.push({
                ...baseRecord,
                item_id: inventoryItems.length > 0 ? inventoryItems[Math.floor(Math.random() * inventoryItems.length)].id : require('crypto').randomUUID(),
            ...
            case 'Purchase Orders':
              const poSubtotal = Math.floor(Math.random() * 4000000) + 100000;
              const poTaxAmount = Math.floor(Math.random() * 400000) + 10000;
            ...
            case 'Warehouses':
              records.push({
                ...
                warehouse_type: ['general', 'cold_storage', 'hazardous', 'bonded', 'distribution'][Math.floor(Math.random() * 5)],
                location: rwandanCities[Math.floor(Math.random() * rwandanCities.length)],
            ...
            case 'Opportunities':
              records.push({
                ...
                opportunity_type: ['new_business', 'upsell', 'cross_sell', 'renewal', 'referral'][Math.floor(Math.random() * 5)],
            ...
            case 'Quotes':
              const quoteSubtotal = Math.floor(Math.random() * 4000000) + 100000;
              const quoteTaxAmount = Math.floor(Math.random() * 400000) + 10000;
              const quoteTotalAmount = quoteSubtotal + quoteTaxAmount;
            ...
            case 'Support Tickets':
              records.push({
                ...
                ticket_type: ['technical', 'billing', 'general', 'urgent', 'feature_request', 'bug_report'][Math.floor(Math.random() * 6)],
                client_id: clients[Math.floor(Math.random() * clients.length)].id,
            ...
            case 'Reports':
              records.push({
                ...
                report_code: `RPT-${String(i).padStart(3, '0')}`,
            ...
            case 'KPIs':
              records.push({
                ...baseRecord,
                kpi_name: `KPI ${i}`,
                kpi_code: `KPI-${String(i).padStart(3, '0')}`,
            ...
            case 'Workflows':
              records.push({
                ...
                total_steps: Math.floor(Math.random() * 10) + 1,
    ...
    console.log('');
    console.log('🎉 COMPREHENSIVE FIXED SEED DATA GENERATION COMPLETED!');
    console.log('');
    console.log('📊 SUMMARY:');
...
// Run the comprehensive fixed seed data generation
comprehensiveFixedSeedData(); 